...
public class StringsQuestion {
    ...
    */
  public static int countMacaroni(String text) {
    int count = 0;
    text = text.toLowerCase(); // convert text to lowercase
    String searchTerm = "macaroni";
    int pos = text.indexOf(searchTerm, 0); // find it first time
    // keep looping as long as we keep finding it
    while (pos >= 0) {
      count++;
  ...
  public static void main(String[] args) throws Exception {
    String text = "macaroni foo bar Macaronimacaroni macaROnibomb";
    System.out.println(String.format("Found 'macaroni' %s times!", countMacaroni(text)));
  }
